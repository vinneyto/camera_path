 ...
 */
import type { SpeedKeyframeCreateInterpolationToNext } from './speedKeyframeCreateInterpolationToNext';

export interface SpeedKeyframeCreate {
  interpolation_to_next?: SpeedKeyframeCreateInterpolationToNext;
  /**
     * @minimum 0
     * @maximum 1
     */
