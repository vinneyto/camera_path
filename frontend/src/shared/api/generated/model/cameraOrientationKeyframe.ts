...
import type { CameraOrientationKeyframeInterpolationToNext } from './cameraOrientationKeyframeInterpolationToNext';

export interface CameraOrientationKeyframe {
  id?: string;
  interpolation_to_next?: CameraOrientationKeyframeInterpolationToNext;
