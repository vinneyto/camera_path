 ...
 */
import type { DepthOfFieldTimelineKeyframes } from './depthOfFieldTimelineKeyframes';

export interface DepthOfFieldTimeline {
  keyframes?: DepthOfFieldTimelineKeyframes;
}
