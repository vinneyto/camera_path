...
export type SpiralSegmentCreateDirection = typeof SpiralSegmentCreateDirection[keyof typeof SpiralSegmentCreateDirection];


export const SpiralSegmentCreateDirection = {
  cw: 'cw',
  ccw: 'ccw',
} as const;
