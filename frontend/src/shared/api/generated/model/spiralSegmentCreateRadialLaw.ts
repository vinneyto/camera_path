...
export type SpiralSegmentCreateRadialLaw = typeof SpiralSegmentCreateRadialLaw[keyof typeof SpiralSegmentCreateRadialLaw];


export const SpiralSegmentCreateRadialLaw = {
  linear: 'linear',
